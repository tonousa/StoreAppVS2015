...
namespace StoreApp.Tests
{
    ...
    public class TestProductController
    {
        ...
        [TestMethod]
        public void GetProduct_ShouldReturnProductWithDifferentId()
        {
            var controller = new ProductController(new TestStoreAppContext());

            var badResult = controller.PutProduct(
                999, GetDemoProduct());

            Assert.IsInstanceOfType(
                badResult, typeof(BadRequestResult));
        }
        ...
        [TestMethod]
        public void GetProduct_ShouldReturnAllProducts()
        {
            var context = new TestStoreAppContext();
